...
import { generateRows } from 'test-app/tests/helpers/generate-rows';
...
module('Integration | Component | table', function (hooks) {
    ...
    hooks.beforeEach(function (this: any) {
        ...
        const columns = makeColumns([
            { valuePath: 'id', name: 'ID', minWidth: 300 },
            { valuePath: 'name', name: 'Name', minWidth: 300 },
            { valuePath: 'date', name: 'Date', minWidth: 300 },
            { valuePath: 'test', name: 'Test', minWidth: 300 },
            { valuePath: 'test1', name: 'Test1', minWidth: 300 },
            { valuePath: 'test2', name: 'Test2', minWidth: 300 }
        ]);
